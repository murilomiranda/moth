...
```{r dissim3_within, fig.width = 12, fig.height = 4}
par(mfrow=c(1, 2))
m.data <- c(mean(for.woo[, 4]), mean(mix.shr[, 4]), mean(agr.mea[, 4]))
m.li <- c(mean(for.woo[, 4]) - sd(for.woo[, 4]), mean(mix.shr[, 4]) - sd(mix.shr[, 4]), 
          mean(agr.mea[, 4]) - sd(agr.mea[, 4]))
m.lu <- c(mean(for.woo[, 4]) + sd(for.woo[, 4]), mean(mix.shr[, 4]) + sd(mix.shr[, 4]), 
          mean(agr.mea[, 4]) + sd(agr.mea[, 4]))
plot(1:3, 1 - m.data, xaxt = "n", ylim=c(0, 1), xlab = "", 
     ylab = expression(~beta*"-diversity"), main = "Jaccard adjusted")
axis(1, at = 1:3, labels = c("Forest", "Shrub", "Meadow"))
segments(x0 = 1:3, y0 = 1 - m.li, y1 = 1 - m.lu, col = 1)

m.data <- c( mean(for.woo[, 5]), mean(mix.shr[, 5]), mean(agr.mea[, 5]))
m.li <- c(mean(for.woo[, 5]) - sd(for.woo[, 5]), mean(mix.shr[, 5]) - sd(mix.shr[, 5]), 
          mean(agr.mea[, 5]) - sd(agr.mea[, 5]))
m.lu <- c(mean(for.woo[, 5]) + sd(for.woo[, 5]), mean(mix.shr[, 5]) + sd(mix.shr[, 5]), 
          mean(agr.mea[, 5]) + sd(agr.mea[, 5]))
plot(1:3, 1 - m.data, xaxt = "n", ylim=c(0, 1), xlab = "", 
     ylab = expression(~beta*"-diversity"), main = "Sorensen adjusted")
axis(1, at = 1:3, labels = c("Forest", "Shrub", "Meadow"))
segments(x0 = 1:3, y0 = 1 - m.li, y1 = 1 - m.lu, col = 1)
```
...
```{r dissim4_within, fig.width = 12, fig.height = 4}
par(mfrow=c(1, 2))
m.data <- c(mean(for.woo[, 4]), mean(tal.shr[, 4]), mean(shr.shr[, 4]), mean(agr.mea[, 4]))
m.li <- c(mean(for.woo[, 4]) - sd(for.woo[, 4]), mean(tal.shr[, 4]) - sd(tal.shr[, 4]), 
          mean(shr.shr[, 4]) - sd(shr.shr[, 4]), mean(agr.mea[, 4]) - sd(agr.mea[, 4]))
m.lu <- c(mean(for.woo[, 4]) + sd(for.woo[, 4]), mean(tal.shr[, 4]) + sd(tal.shr[, 4]), 
          mean(shr.shr[, 4]) + sd(shr.shr[, 4]), mean(agr.mea[, 4]) + sd(agr.mea[, 4]))
plot(1:4, 1 - m.data, xaxt = "n", ylim=c(0, 1), xlab = "", ylab = 
       expression(~beta*"-diversity"), main = "Jaccard adjusted")
...
m.li <- c(mean(for.woo[, 5]) - sd(for.woo[, 5]), mean(tal.shr[, 5]) - sd(tal.shr[, 5]), 
          mean(shr.shr[, 5]) - sd(shr.shr[, 5]), mean(agr.mea[, 5]) - sd(agr.mea[, 5]))
m.lu <- c(mean(for.woo[, 5]) + sd(for.woo[, 5]), mean(tal.shr[, 5]) + sd(tal.shr[, 5]), 
          mean(shr.shr[, 5]) + sd(shr.shr[, 5]), mean(agr.mea[, 5]) + sd(agr.mea[, 5]))
plot(1:4, 1 - m.data, xaxt = "n", ylim=c(0, 1), xlab = "", 
     ylab = expression(~beta*"-diversity"), main = "Sorensen adjusted")
axis(1, at = 1:4, labels = c("Forest", "Tall", "Short", "Meadow"))
segments(x0 = 1:4, y0 = 1 - m.li, y1 = 1 - m.lu, col = 1)
```
...
```{r dissim3_between, fig.width = 12, fig.height = 4}
par(mfrow=c(1, 2))
m.data <- c(mean(woo[, 4]), mean(mix[, 4]), mean(mea[, 4]) )
m.li <- c(mean(woo[, 4]) - sd(woo[, 4]), mean(mix[, 4]) - sd(mix[, 4]), 
          mean(mea[, 4]) - sd(mea[, 4]))
m.lu <- c(mean(woo[, 4]) + sd(woo[, 4]), mean(mix[, 4]) + sd(mix[, 4]), 
          mean(mea[, 4]) + sd(mea[, 4]))
plot(1:3, 1 - m.data, xaxt = "n", ylim=c(0, 1), xlab = "", 
     ylab = expression(~beta*"-diversity"), main = "Jaccard adjusted")
axis(1, at = 1:3, labels = c("Forest", "Shrub", "Meadow"))
...
m.li <- c(mean(woo[, 5]) - sd(woo[, 5]), mean(mix[, 5]) - sd(mix[, 5]), 
          mean(mea[, 5]) - sd(mea[, 5]))
m.lu <- c(mean(woo[, 5]) + sd(woo[, 5]), mean(mix[, 5]) + sd(mix[, 5]), 
          mean(mea[, 5]) + sd(mea[, 5]))
plot(1:3, 1 - m.data, xaxt = "n", ylim=c(0, 1), xlab = "", 
     ylab = expression(~beta*"-diversity"), main = "Sorensen adjusted")
axis(1, at = 1:3, labels = c("Forest", "Shrub", "Meadow"))
...
```{r dissim4_between, fig.width = 12, fig.height = 4}
par(mfrow=c(1, 2))
m.data <- c(mean(woo[, 4]), mean(tal[, 4]), mean(shr[, 4]), mean(mea[, 4]) )
m.li <- c(mean(woo[, 4]) - sd(woo[, 4]), mean(tal[, 4]) - sd(tal[, 4]), 
          mean(shr[, 4]) - sd(shr[, 4]), mean(mea[, 4]) - sd(mea[, 4]))
m.lu <- c(mean(woo[, 4]) + sd(woo[, 4]), mean(tal[, 4]) + sd(tal[, 4]), 
          mean(shr[, 4]) + sd(shr[, 4]), mean(mea[, 4]) + sd(mea[, 4]))
plot(1:4, 1 - m.data, xaxt = "n", ylim=c(0, 1), xlab = "", 
     ylab = expression(~beta*"-diversity"), main = "Jaccard adjusted")
axis(1, at = 1:4, labels = c("Forest", "Tall", "Short", "Meadow"))
...
m.li <- c(mean(woo[, 5]) - sd(woo[, 5]), mean(tal[, 5]) - sd(tal[, 5]), 
          mean(shr[, 5]) - sd(shr[, 5]), mean(mea[, 5]) - sd(mea[, 5]))
m.lu <- c(mean(woo[, 5]) + sd(woo[, 5]), mean(tal[, 5]) + sd(tal[, 5]), 
          mean(shr[, 5]) + sd(shr[, 5]), mean(mea[, 5]) + sd(mea[, 5]))
plot(1:4, 1 - m.data, xaxt = "n", ylim=c(0, 1), xlab = "", 
     ylab = expression(~beta*"-diversity"), main = "Sorensen adjusted")
axis(1, at = 1:4, labels = c("Forest", "Tall", "Short", "Meadow"))
...
```{r dissim3_all, fig.width = 12, fig.height = 4}
par(mfrow=c(1, 2))
m.data <- c(mean(woo.bio[, 4]), mean(mix.bio[, 4]), mean(mea.bio[, 4]))
m.li <- c(mean(woo.bio[, 4]) - sd(woo.bio[, 4]), mean(mix.bio[, 4]) - sd(mix.bio[, 4]), 
          mean(mea.bio[, 4]) - sd(mea.bio[, 4]))
m.lu <- c(mean(woo.bio[, 4]) + sd(woo.bio[, 4]), mean(mix.bio[, 4]) + sd(mix.bio[, 4]), 
          mean(mea.bio[, 4]) + sd(mea.bio[, 4]))
plot(1:3, 1 - m.data, xaxt = "n", ylim=c(0, 1), xlab = "", 
     ylab = expression(~beta*"-diversity"), main = "Jaccard adjusted")
axis(1, at = 1:3, labels = c("Forest", "Shrub", "Meadow"))
...
m.li <- c(mean(woo.bio[, 5]) - sd(woo.bio[, 5]), mean(mix.bio[, 5]) - sd(mix.bio[, 5]), 
          mean(mea.bio[, 5]) - sd(mea.bio[, 5]))
m.lu <- c(mean(woo.bio[, 5]) + sd(woo.bio[, 5]), mean(mix.bio[, 5]) + sd(mix.bio[, 5]), 
          mean(mea.bio[, 5]) + sd(mea.bio[, 5]))
plot(1:3, 1 - m.data, xaxt = "n", ylim=c(0, 1), xlab = "", 
     ylab = expression(~beta*"-diversity"), main = "Sorensen adjusted")
axis(1, at = 1:3, labels = c("Forest", "Shrub", "Meadow"))
...
```{r dissim4_all, fig.width = 12, fig.height = 4}
par(mfrow=c(1, 2))
m.data <- c(mean(woo.bio[, 4]), mean(tal.bio[, 4]), mean(sho.bio[, 4]), mean(mea.bio[, 4]))
m.li <- c(mean(woo.bio[, 4]) - sd(woo.bio[, 4]), mean(tal.bio[, 4]) - sd(tal.bio[, 4]), 
          mean(sho.bio[, 4]) - sd(sho.bio[, 4]), mean(mea.bio[, 4]) - sd(mea.bio[, 4]))
m.lu <- c(mean(woo.bio[, 4]) + sd(woo.bio[, 4]), mean(tal.bio[, 4]) + sd(tal.bio[, 4]), 
          mean(sho.bio[, 4]) + sd(sho.bio[, 4]), mean(mea.bio[, 4]) + sd(mea.bio[, 4]))
plot(1:4, 1 - m.data, xaxt = "n", ylim=c(0, 1), xlab = "", 
     ylab = expression(~beta*"-diversity"), main = "Jaccard adjusted")
axis(1, at = 1:4, labels = c("Forest", "Tall", "Short", "Meadow"))
...
m.li <- c(mean(woo.bio[, 5]) - sd(woo.bio[, 5]), mean(tal.bio[, 5]) - sd(tal.bio[, 5]), 
          mean(sho.bio[, 5]) - sd(sho.bio[, 5]), mean(mea.bio[, 5]) - sd(mea.bio[, 5]))
m.lu <- c(mean(woo.bio[, 5]) + sd(woo.bio[, 5]), mean(tal.bio[, 5]) + sd(tal.bio[, 5]), 
          mean(sho.bio[, 5]) + sd(sho.bio[, 5]), mean(mea.bio[, 5]) + sd(mea.bio[, 5]))
plot(1:4, 1 - m.data, xaxt = "n", ylim=c(0, 1), xlab = "", 
     ylab = expression(~beta*"-diversity"), main = "Sorensen adjusted")
axis(1, at = 1:4, labels = c("Forest", "Tall", "Short", "Meadow"))
...
```{r}
plot.scale <- function(base, estimator = 0){
  ...
  lines(446:1810, rep(1 - mean(div[(area <= 1810) & (area > 445)]), 1365), col = 2, lwd = 4.5)
  lines(1811:7500, rep(1 - mean(div[area > 1811]), 5690), col = 2, lwd = 4.5)
}
```

1. Forest

```{r forest_scale, fig.width = 12, fig.height = 6, echo = TRUE}
par(mfrow=c(1, 2))
plot.scale(woo.bio)
plot.scale(woo.bio, 1)
```

2. Shrub

```{r shrub_scale, fig.width = 12, fig.height = 6, echo = FALSE}
par(mfrow=c(1, 2))
plot.scale(mix.bio)
plot.scale(mix.bio, 1)
```

3. Meadow

```{r meadow_scale, fig.width = 12, fig.height = 6, echo = FALSE}
par(mfrow=c(1, 2))
plot.scale(mea.bio)
plot.scale(mea.bio, 1)
```
...
```{r tall_scale, fig.width = 12, fig.height = 6, echo = FALSE}
par(mfrow=c(1, 2))
plot.scale(tal.bio)
plot.scale(tal.bio, 1)
```

5. Short Shrub

```{r short_scale, fig.width = 12, fig.height = 6, echo = FALSE}
par(mfrow=c(1, 2))
plot.scale(sho.bio)
plot.scale(sho.bio, 1)
```
...
```{r forestscale_boot, fig.width = 12, fig.height = 6, echo = TRUE}
jsf <- boot(data = 1 - woo.bio[woo.bio[, 6] <= 115, 4], statistic = mean.fun, R = 2000)
jmf <- boot(data = 1 - woo.bio[(woo.bio[, 6] <= 445) & (woo.bio[, 6] > 115), 4], 
            statistic = mean.fun, R = 2000)
jlf <- boot(data = 1 - woo.bio[(woo.bio[, 6] <= 1810) & (woo.bio[, 6] > 445), 4], 
            statistic = mean.fun, R = 2000)
jxf <- boot(data = 1 - woo.bio[woo.bio[, 6] > 1811, 4], statistic = mean.fun, R = 2000)
...
ssf <- boot(data = 1 - woo.bio[woo.bio[, 6] <= 115, 5], statistic = mean.fun, R = 2000)
smf <- boot(data = 1 - woo.bio[(woo.bio[, 6] <= 445) & (woo.bio[, 6] > 115), 5], 
            statistic = mean.fun, R = 2000)
slf <- boot(data = 1 - woo.bio[(woo.bio[, 6] <= 1810) & (woo.bio[, 6] > 445), 5],
            statistic = mean.fun, R = 2000)
sxf <- boot(data = 1 - woo.bio[woo.bio[, 6] > 1811, 5], statistic = mean.fun, R = 2000)
...
print(xtable(jci.for, digits = 4, caption = "Jaccard"), type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(sci.for, digits = 4, caption = "Sorensen"), type = "latex", comment = FALSE)
```

2. Shrub

```{r shrubscale_boot, fig.width = 12, fig.height = 6, echo = FALSE}
jsm <- boot(data = 1 - mix.bio[mix.bio[, 6] <= 115, 4], statistic = mean.fun, R = 2000)
jmm <- boot(data = 1 - mix.bio[(mix.bio[, 6] <= 445) & (mix.bio[, 6] > 115), 4], statistic = mean.fun, R = 2000)
jlm <- boot(data = 1 - mix.bio[(mix.bio[, 6] <= 1810) & (mix.bio[, 6] > 445), 4], statistic = mean.fun, R = 2000)
jxm <- boot(data = 1 - mix.bio[mix.bio[, 6] > 1811, 4], statistic = mean.fun, R = 2000)
...
ssm <- boot(data = 1 - mix.bio[mix.bio[, 6] <= 115, 5], statistic = mean.fun, R = 2000)
smm <- boot(data = 1 - mix.bio[(mix.bio[, 6] <= 445) & (mix.bio[, 6] > 115), 5], statistic = mean.fun, R = 2000)
slm <- boot(data = 1 - mix.bio[(mix.bio[, 6] <= 1810) & (mix.bio[, 6] > 445), 5], statistic = mean.fun, R = 2000)
sxm <- boot(data = 1 - mix.bio[mix.bio[, 6] > 1811, 5], statistic = mean.fun, R = 2000)
...
```{r, echo = FALSE, results = 'asis'}
print(xtable(jci.mix, digits = 4, caption = "Jaccard"), type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(sci.mix, digits = 4, caption = "Sorensen"), type = "latex", comment = FALSE)
```

3. Meadow

```{r meadowscale_boot, fig.width = 12, fig.height = 6, echo = FALSE}
jsa <- boot(data = 1 - mea.bio[mea.bio[, 6] <= 115, 4], statistic = mean.fun, R = 2000)
jma <- boot(data = 1 - mea.bio[(mea.bio[, 6] <= 445) & (mea.bio[, 6] > 115), 4], statistic = mean.fun, R = 2000)
jla <- boot(data = 1 - mea.bio[(mea.bio[, 6] <= 1810) & (mea.bio[, 6] > 445), 4], statistic = mean.fun, R = 2000)
jxa <- boot(data = 1 - mea.bio[mea.bio[, 6] > 1811, 4], statistic = mean.fun, R = 2000)
...
ssa <- boot(data = 1 - mea.bio[mea.bio[, 6] <= 115, 5], statistic = mean.fun, R = 2000)
sma <- boot(data = 1 - mea.bio[(mea.bio[, 6] <= 445) & (mea.bio[, 6] > 115), 5], statistic = mean.fun, R = 2000)
sla <- boot(data = 1 - mea.bio[(mea.bio[, 6] <= 1810) & (mea.bio[, 6] > 445), 5], statistic = mean.fun, R = 2000)
sxa <- boot(data = 1 - mea.bio[mea.bio[, 6] > 1811, 5], statistic = mean.fun, R = 2000)
...
```{r, echo = FALSE, results = 'asis'}
print(xtable(jci.mea, digits = 4, caption = "Jaccard"), type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(sci.mea, digits = 4, caption = "Sorensen"), type = "latex", comment = FALSE)
```
...
jst <- boot(data = 1 - tal.bio[tal.bio[, 6] <= 115, 4], statistic = mean.fun, R = 2000)
jmt <- boot(data = 1 - tal.bio[(tal.bio[, 6] <= 445) & (tal.bio[, 6] > 115), 4], statistic = mean.fun, R = 2000)
jlt <- boot(data = 1 - tal.bio[(tal.bio[, 6] <= 1810) & (tal.bio[, 6] > 445), 4], statistic = mean.fun, R = 2000)
jxt <- boot(data = 1 - tal.bio[tal.bio[, 6] > 1811, 4], statistic = mean.fun, R = 2000)
...
sst <- boot(data = 1 - tal.bio[tal.bio[, 6] <= 115, 5], statistic = mean.fun, R = 2000)
smt <- boot(data = 1 - tal.bio[(tal.bio[, 6] <= 445) & (tal.bio[, 6] > 115), 5], statistic = mean.fun, R = 2000)
slt <- boot(data = 1 - tal.bio[(tal.bio[, 6] <= 1810) & (tal.bio[, 6] > 445), 5], statistic = mean.fun, R = 2000)
sxt <- boot(data = 1 - tal.bio[tal.bio[, 6] > 1811, 5], statistic = mean.fun, R = 2000)
...
```{r, echo = FALSE, results = 'asis'}
print(xtable(jci.tal, digits = 4, caption = "Jaccard"), type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(sci.tal, digits = 4, caption = "Sorensen"), type = "latex", comment = FALSE)
```
...
jss <- boot(data = 1 - sho.bio[sho.bio[, 6] <= 115, 4], statistic = mean.fun, R = 2000)
jms <- boot(data = 1 - sho.bio[(sho.bio[, 6] <= 445) & (sho.bio[, 6] > 115), 4], statistic = mean.fun, R = 2000)
jls <- boot(data = 1 - sho.bio[(sho.bio[, 6] <= 1810) & (sho.bio[, 6] > 445), 4], statistic = mean.fun, R = 2000)
jxs <- boot(data = 1 - sho.bio[sho.bio[, 6] > 1811, 4], statistic = mean.fun, R = 2000)
...
sss <- boot(data = 1 - sho.bio[sho.bio[, 6] <= 115, 5], statistic = mean.fun, R = 2000)
sms <- boot(data = 1 - sho.bio[(sho.bio[, 6] <= 445) & (sho.bio[, 6] > 115), 5], statistic = mean.fun, R = 2000)
sls <- boot(data = 1 - sho.bio[(sho.bio[, 6] <= 1810) & (sho.bio[, 6] > 445), 5], statistic = mean.fun, R = 2000)
sxs <- boot(data = 1 - sho.bio[sho.bio[, 6] > 1811, 5], statistic = mean.fun, R = 2000)
...
```{r, echo = FALSE, results = 'asis'}
print(xtable(jci.sho, digits = 4, caption = "Jaccard"), type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(sci.sho, digits = 4, caption = "Sorensen"), type = "latex", comment = FALSE)
```
...
```{r interc3_jac, fig.width = 12, fig.height = 4}
par(mfrow = c(1, 3))
...
```{r dissim3_jac, fig.width = 12, fig.height = 4}
par(mfrow = c(1, 3))
...
```{r slope3_jac, fig.width = 12, fig.height = 4}
par(mfrow = c(1, 3))
...
```{r r-quar3_jac, fig.width = 12, fig.height = 4}
par(mfrow = c(1, 3))
...
```{r interc3_sor, fig.width = 12, fig.height = 4}
par(mfrow = c(1, 3))
...
```{r dissim3_sor, fig.width = 12, fig.height = 4}
par(mfrow = c(1, 3))
...
```{r slope3_sor, fig.width = 12, fig.height = 4}
par(mfrow = c(1, 3))
...
```{r r-squar3_sor, fig.width = 12, fig.height = 4}
par(mfrow = c(1, 3))
...
```{r interc4_jac, fig.width = 12, fig.height = 4}
par(mfrow = c(1, 3))
...
```{r dissim4_jac, fig.width = 12, fig.height = 4}
par(mfrow = c(1, 3))
...
```{r slope4_jac, fig.width = 12, fig.height = 4}
par(mfrow = c(1, 3))
...
```{r r-squar4_jac, fig.width = 12, fig.height = 4}
par(mfrow = c(1, 3))
...
```{r interc4_sor, fig.width = 12, fig.height = 4}
par(mfrow = c(1, 3))
...
```{r dissim4_sor, fig.width = 12, fig.height = 4}
par(mfrow = c(1, 3))
...
```{r slope4_sor, fig.width = 12, fig.height = 4}
par(mfrow = c(1, 3))
...
```{r r-squar4_sor, fig.width = 12, fig.height = 4}
par(mfrow = c(1, 3))
...
```{r, echo = FALSE}
boot.table <- function(base1, base2, base3, base4, base5, index = 1){
  #1: intercept; 2: slope; 3: r-square and 4: dissimilarity (default is intercept)
  mean.ci <- c(base1[index, 1], base2[index, 1], base3[index, 1], base4[index, 1], base5[index, 1])
  lower.ci <- c(base1[index, 2], base2[index, 2], base3[index, 2], base4[index, 2], base5[index, 2])
  upper.ci <- c(base1[index, 3], base2[index, 3], base3[index, 3], base4[index, 3], base5[index, 3])
  xt <- cbind(mean.ci, lower.ci, upper.ci)
  if(index == 4) xt <- 1 - xt
  rownames(xt) <- c("Forest", "Shrub", "Tall", "Short", "Meadow")
  xt
}
```
...
```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(wl.jforres.ci, wl.jmixres.ci, wl.jtalres.ci, wl.jshrres.ci, wl.jmeares.ci), 
             digits = 4, caption = "Intercept"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(wl.jforres.ci, wl.jmixres.ci, wl.jtalres.ci, wl.jshrres.ci, wl.jmeares.ci, 4), 
             digits = 4, caption = "Dissimilarity"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(wl.jforres.ci, wl.jmixres.ci, wl.jtalres.ci, wl.jshrres.ci, wl.jmeares.ci, 2), 
             digits = 6, caption = "Slope"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(wl.jforres.ci, wl.jmixres.ci, wl.jtalres.ci, wl.jshrres.ci, wl.jmeares.ci, 3), 
             digits = 4, caption = "R-square"), floating = FALSE, type = "latex", comment = FALSE)
```

2. Between landscapes

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(bl.jforres.ci, bl.jmixres.ci, bl.jtalres.ci, bl.jshrres.ci, bl.jmeares.ci), 
             digits = 4, caption = "Intercept"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(bl.jforres.ci, bl.jmixres.ci, bl.jtalres.ci, bl.jshrres.ci, bl.jmeares.ci, 4), 
             digits = 4, caption = "Dissimilarity"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(bl.jforres.ci, bl.jmixres.ci, bl.jtalres.ci, bl.jshrres.ci, bl.jmeares.ci, 2), 
             digits = 6, caption = "Slope"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(bl.jforres.ci, bl.jmixres.ci, bl.jtalres.ci, bl.jshrres.ci, bl.jmeares.ci, 3), 
             digits = 4, caption = "R-square"), floating = FALSE, type = "latex", comment = FALSE)
```

3. All biotopes
```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(al.jforres.ci, al.jmixres.ci, al.jtalres.ci, al.jshrres.ci, al.jmeares.ci), 
             digits = 4, caption = "Intercept"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(al.jforres.ci, al.jmixres.ci, al.jtalres.ci, al.jshrres.ci, al.jmeares.ci, 4), 
             digits = 4, caption = "Dissimilarity"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(al.jforres.ci, al.jmixres.ci, al.jtalres.ci, al.jshrres.ci, al.jmeares.ci, 2), 
             digits = 6, caption = "Slope"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(al.jforres.ci, al.jmixres.ci, al.jtalres.ci, al.jshrres.ci, al.jmeares.ci, 3), 
             digits = 4, caption = "R-square"), floating = FALSE, type = "latex", comment = FALSE)
```
...
```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(wl.sforres.ci, wl.smixres.ci, wl.stalres.ci, wl.sshrres.ci, wl.smeares.ci), 
             digits = 4, caption = "Intercept"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(wl.sforres.ci, wl.smixres.ci, wl.stalres.ci, wl.sshrres.ci, wl.smeares.ci, 4), 
             digits = 4, caption = "Dissimilarity"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(wl.sforres.ci, wl.smixres.ci, wl.stalres.ci, wl.sshrres.ci, wl.smeares.ci, 2), 
             digits = 6, caption = "Slope"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(wl.sforres.ci, wl.smixres.ci, wl.stalres.ci, wl.sshrres.ci, wl.smeares.ci, 3), 
             digits = 4, caption = "R-square"), floating = FALSE, type = "latex", comment = FALSE)
```
...
```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(bl.sforres.ci, bl.smixres.ci, bl.stalres.ci, bl.sshrres.ci, bl.smeares.ci), 
             digits = 4, caption = "Intercept"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(bl.sforres.ci, bl.smixres.ci, bl.stalres.ci, bl.sshrres.ci, bl.smeares.ci, 4), 
             digits = 4, caption = "Dissimilarity"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(bl.sforres.ci, bl.smixres.ci, bl.stalres.ci, bl.sshrres.ci, bl.smeares.ci, 2), 
             digits = 6, caption = "Slope"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(bl.sforres.ci, bl.smixres.ci, bl.stalres.ci, bl.sshrres.ci, bl.smeares.ci, 3), 
             digits = 4, caption = "R-square"), floating = FALSE, type = "latex", comment = FALSE)
```

3. All biotopes
```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(al.sforres.ci, al.smixres.ci, al.stalres.ci, al.sshrres.ci, al.smeares.ci), 
             digits = 4, caption = "Intercept"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(al.sforres.ci, al.smixres.ci, al.stalres.ci, al.sshrres.ci, al.smeares.ci, 4), 
             digits = 4, caption = "Dissimilarity"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(al.sforres.ci, al.smixres.ci, al.stalres.ci, al.sshrres.ci, al.smeares.ci, 2), 
             digits = 6, caption = "Slope"), floating = FALSE, type = "latex", comment = FALSE)
```

```{r, echo = FALSE, results = 'asis'}
print(xtable(boot.table(al.sforres.ci, al.smixres.ci, al.stalres.ci, al.sshrres.ci, al.smeares.ci, 3), 
             digits = 4, caption = "R-square"), floating = FALSE, type = "latex", comment = FALSE)
```
